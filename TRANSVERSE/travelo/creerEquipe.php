                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="nbr" id="nbr" type="text"  placeholder="Combien de joueurs manquent ?">
                                        
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                                        <input class="form-control valid" name="villeEquipe" id="villeEquipe" type="text" placeholder="Dans quelle ville voulez vous jouer ?">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="five" id="five" type="text" placeholder="Nom du terrain/five ?">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <input class="form-control" name="createur" id="createur" type="text" placeholder="createur">
                                    </div>
                                </div>
